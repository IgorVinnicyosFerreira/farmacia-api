...
return [
    'dependencies' => [
        'factories' => [
            ...
            Cadastro\Model\Validator\ClienteValidator::class => Cadastro\Model\Validator\ClienteValidatorFactory::class,
            Cadastro\Model\Validator\RemedioValidator::class => Cadastro\Model\Validator\RemedioValidatorFactory::class,
            Cadastro\Model\Validator\UsuarioValidator::class => Cadastro\Model\Validator\UsuarioValidatorFactory::class,
        ],
    ],
];
